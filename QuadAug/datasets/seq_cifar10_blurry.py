...
class SequentialCIFAR10Blurry(ContinualDataset):
    ...
    def __init__(self, args):
        ...
        self.train_dataset = MyCIFAR10(base_path() + 'CIFAR10', train=True, download=False, transform=transform)

        if self.args.validation:
            self.train_dataset, self.test_dataset = get_train_val(self.train_dataset, test_transform, self.NAME)
        else:
            self.test_dataset = CIFAR10(base_path() + 'CIFAR10', train=False, download=False, transform=test_transform)
